...
public class Imgproc {
    ...
    public static void drawContours(Mat image, List<MatOfPoint> contours, int contourIdx, Scalar color)
    {
        ...
        public static void drawCircle(Mat image, Mat contours, int contourIdx, Scalar color)
        {

                drawContours_2(image.nativeObj, contours.nativeObj, contourIdx, color.val[0], color.val[1], color.val[2], color.val[3]);
